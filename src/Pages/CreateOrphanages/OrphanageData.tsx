...
export default function OrphanageData() {
  ...
  const [ImagesUp, setImages] = useState<string[]>([]);

  const navigation = useNavigation();

  const routeParams = route.params as CreateOrphanage;
  ...
  async function handleSelectImage(){
    ...
    if(status != 'granted'){
      alert('Precisamos de acessoa suas fotos.')
      return;
    }
