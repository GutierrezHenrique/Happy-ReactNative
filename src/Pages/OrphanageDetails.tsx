...
import mapMarkerImg from '../Sources/MapMarker.png';
...
export default function OrphanageDetails() {
  ...
  const [Orphanage, OrphanageSet] = useState<Orphanages>();

  const params = route.params as OrphanageDetailsRouteParams;

  function handleOpenGoogleMap(){
    Linking.openURL(`https://maps.google.com/?q=${Orphanage?.latitude},${Orphanage?.longitude}`)
  }

  useEffect(() => {
    api.get(`orphanages/${params.id}`)
    .then(response =>{
      OrphanageSet(response.data)
    })
  }, [params.id])
